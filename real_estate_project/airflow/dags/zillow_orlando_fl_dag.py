...
today = date.today()
LOCAL_OUTPUT_PATH = AIRFLOW_HOME + "/orlando_fl_zillow_" + str(today) + ".csv"
GCS_PATH = "real_estate/orlando_fl_zillow_" + str(today) + ".csv"

orlando_fl_params = dict(
    city="Orlando",
    state="FL",
    west="-81.72543655371092",
    east="-80.84241043066405",
    south="27.97036966271648",
    north="29.02517407412733",
    region_id="13121",
    region_type="6",
)
